...
public class MainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        hello = rootView.findViewById(R.id.image_text);
    ...
    public void setArgs() {
            SharedPreferences sharedPref = getActivity().getSharedPreferences("default", Context.MODE_PRIVATE);
        if (!mParam1.equals("")) {
            text = sharedPref.getString("textToTranslate", mParam1);
            //mParam1 = "abc";
        }
        else{
             text = sharedPref.getString("textToTranslate", "");}
